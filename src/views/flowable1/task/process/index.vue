<template>
  <div class="app-container">
    ...
    <el-dialog
      title="标题"
      :visible.sync="newPpen"
      width="500px"
      append-to-body
    >
      <el-form ref="form" :model="newForm" label-width="80px">
        <el-form-item label="名称" prop="name">
          <el-input v-model="newForm.name" placeholder="请输入看看" />
        </el-form-item>
        <el-form-item label="性别" prop="sex">
          <el-input v-model="newForm.sex" placeholder="请输入看看" />
        </el-form-item>
      </el-form>
...
import { getNew } from "@/api/flowable/task";
